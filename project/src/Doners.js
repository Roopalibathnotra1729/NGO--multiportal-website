...
function Doners() {
  const navigate = useNavigate();
    ...
    function getblood(x){
        var gqr = db.collection('Donation');
        if(x){
            gqr = gqr.where('City','==',x)
        }else{
            gqr = gqr
        }
            ...
            <Card>
                <Grid container>
                    ...
                    <CardContent>
                        <label>City</label>
                      <Select label='City'
                      fullWidth size='small' name='city' variant='outlined' required onChange={(e) => getblood(e.target.value)}>
                                    ...
                                    <CardContent>
                                        <Card>
                                            <CardContent>
                                                ...
                                                <Typography><b>Description -</b> {row.data().Desc}</Typography>
